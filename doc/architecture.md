...
│   └── logic.py         # 逻辑：索引切换、Any 打包/解包、遮罩判空、类型转换（SFConvertAnything 复刻 easy convertAnything，输出槽前端改型见 patterns.md §41）、循环（For/While Loop）
├── sf_utils/            # 共享工具库
