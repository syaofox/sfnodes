...
.sf-preset-picker{background:var(--sf-panel-bg);border:1px solid var(--sf-border-soft);border-radius:8px;box-shadow:0 8px 30px rgba(0,0,0,0.6);width:min(520px,92vw);max-height:80vh;display:flex;flex-direction:column;font-size:12px;color:var(--sf-text);}
.sf-preset-picker-head{display:flex;align-items:center;justify-content:space-between;padding:8px 12px;border-bottom:1px solid var(--sf-border-soft);font-weight:600;font-size:13px;}
.sf-preset-picker-close{background:none;border:none;color:var(--sf-text-dim);font-size:16px;cursor:pointer;padding:0 4px;}
.sf-preset-picker-close:hover{color:var(--sf-text-strong);}
.sf-preset-picker-tabs{display:flex;flex-wrap:wrap;gap:4px;padding:8px 12px;border-bottom:1px solid var(--sf-border-soft);}
.sf-preset-picker-tab{padding:3px 10px;border-radius:4px;cursor:pointer;background:var(--sf-surface);border:1px solid transparent;color:var(--sf-text-dim);}
.sf-preset-picker-tab:hover{background:var(--sf-surface-hover);color:var(--sf-text-strong);}
...
.sf-preset-picker-group-chip{padding:2px 10px;border-radius:10px;cursor:pointer;background:var(--sf-surface);color:var(--sf-text-dim);font-size:11px;border:1px solid transparent;}
.sf-preset-picker-group-chip:hover{background:var(--sf-surface-hover);color:var(--sf-text-strong);}
.sf-preset-picker-group-chip.active{background:#3a5f8a;border-color:#4a7ab0;color:#fff;}
.sf-preset-picker-search{margin:8px 12px;padding:5px 8px;background:var(--sf-input-bg);border:1px solid var(--sf-border-soft);border-radius:4px;color:var(--sf-text);font-size:12px;box-sizing:border-box;width:calc(100% - 24px);}
.sf-preset-picker-list{overflow-y:auto;padding:4px 8px 12px;min-height:200px;}
.sf-preset-picker-group{position:sticky;top:0;background:var(--sf-panel-bg);padding:5px 8px 3px;font-size:11px;color:var(--sf-text-dim);font-weight:600;border-bottom:1px solid var(--sf-border-soft);margin-top:4px;}
...
.sf-preset-picker-item:hover{background:var(--sf-surface-hover);}
.sf-preset-picker-item.active{background:#3a5f8a;}
.sf-preset-picker-empty{padding:20px;text-align:center;color:var(--sf-text-faint);}
.sf-preset-picker-preview{padding:6px 12px;border-top:1px solid var(--sf-border-soft);color:var(--sf-text-dim);font-size:11px;line-height:1.5;min-height:16px;max-height:48px;overflow:hidden;}
`;
...
function renderPickerList() {
    ...
    const addGroupTitle = (group) => {
        ...
        dice.textContent = "🎲 随机";
        dice.style.cssText = [
            "background:none", "border:none", "color:var(--sf-text-dim)", "cursor:pointer",
            "font-size:11px", "padding:0 4px", "border-radius:3px",
        ].join(";");
        dice.addEventListener("mouseenter", () => { dice.style.color = "var(--sf-text-strong)"; });
        dice.addEventListener("mouseleave", () => { dice.style.color = "var(--sf-text-dim)"; });
