...
/* 完整展示缩略图（不裁切）：contain 整图可见，四周留白用卡片背景填充 */
.sf-ss-card img{width:100%;height:72px;min-height:72px;object-fit:contain;border-radius:4px;background:#1a1a1a;flex:0 0 auto;}
