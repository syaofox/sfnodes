...
from .....model.vae.modules.commons.layers import Conv1d
...
class WN(torch.nn.Module):
    def __init__(
        ...
        for i in range(n_layers):
            ...
            in_layer = Conv1d(hidden_channels, 2 * hidden_channels, kernel_size, dilation=dilation, causal=causal)
...
class ResidualCouplingBlock(nn.Module):
    def __init__(
        self, channels, hidden_channels, kernel_size, dilation_rate, n_layers, n_flows=4, gin_channels=0, causal=True
    ):
        super().__init__()
        self.channels = channels
        self.hidden_channels = hidden_channels
