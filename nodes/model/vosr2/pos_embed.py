# Vendored from VOSR's models/pos_embed.py via ylchen333/ComfyUI-VOSR2
# (Apache-2.0; upstream: EVA-02 rotary embeddings, MIT, adapted from
# lucidrains/rotary-embedding-torch). Trimmed to VisionRotaryEmbeddingFast and
# its helpers -- the only pieces LightningDiT's use_rope path calls.
import torch
