# Vendored from VOSR's models/qwenimage_vae2d.py via ylchen333/ComfyUI-VOSR2
# (Apache-2.0; upstream: Qwen-Image / Wan / HuggingFace teams, Apache-2.0).
#
...
# 这里保持自包含：普通 nn.Module + from_pretrained() 读取同样的
# config.json/safetensors 布局 + 仅含本节点所需两个方法的本地
# DiagonalGaussianDistribution（.mode()/.sample()），不引入 diffusers 依赖。
import json
