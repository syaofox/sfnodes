...
m, c = reset()
out_m, out_c, triggers, _, _ = node.apply(m, c, LoraLoaderState=state([
...
m, c = reset()
out_m, _, _, _, _ = node.apply(m, c, LoraLoaderState=state([
...
out_m, out_c, _, _, _ = node.apply(m, c, LoraLoaderState=state([
...
m, c = reset()
out_m, _, triggers, _, _ = node.apply(m, c, LoraLoaderState=state([
...
m, c = reset()
out_m, out_c, _, _, _ = node.apply(m, None, LoraLoaderState=state([
