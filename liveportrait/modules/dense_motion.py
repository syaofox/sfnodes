...
class DenseMotionNetwork(nn.Module):
    def __init__(
        ...
        )  # 65G! NOTE: computation cost is large
    ...
    def create_sparse_motions(self, feature, kp_driving, kp_source):
        ...
        identity_grid = identity_grid.view(
            1, 1, d, h, w, 3
    ...
    def forward(self, feature, kp_driving, kp_source):
        ...
        )  # (bs, 1+num_kp, c=4, d=16, h=64, w=64)
        ...
        input = torch.cat(
            [heatmap, deformed_feature], dim=2
        )  # (bs, 1+num_kp, c=5, d=16, h=64, w=64)
        ...
        deformation = (sparse_motion * mask).sum(
            dim=1
        )  # (bs, 3, d, h, w)  mask take effect in this place
