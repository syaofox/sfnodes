...
class FaceAnalysisDIY(FaceAnalysis):
    def __init__(
        ...
        super().__init__(
            name=name, root=root, allowed_modules=allowed_modules, **kwargs
        )
    ...
    def get(self, img_bgr, **kwargs):
        max_num = kwargs.get(
            "max_num", 0
        )  # the number of the detected faces, 0 means no limit
        flag_do_landmark_2d_106 = kwargs.get(
            "flag_do_landmark_2d_106", True
        )  # whether to do 106-point detection
