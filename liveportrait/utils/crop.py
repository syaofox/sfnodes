...
def parse_pt2_from_pt68(pt68, use_lip=True):
    ...
    if use_lip:
        pt68 = np.stack(
            [
                (pt68[42] + pt68[43] + pt68[44] + pt68[45] + pt68[46] + pt68[47])
                / 6,  # left eye
                (pt68[36] + pt68[37] + pt68[38] + pt68[39] + pt68[40] + pt68[41])
                / 6,  # right eye
                (pt68[48] + pt68[54]) / 2,
            ],
            axis=0,
        )
        pt2 = np.stack([(pt68[0] + pt68[1]) / 2, pt68[2]], axis=0)
    else:
        pt2 = np.stack(
            [
                (pt68[42] + pt68[43] + pt68[44] + pt68[45] + pt68[46] + pt68[47])
...
def crop_image(img, pts: np.ndarray, **kwargs):
    ...
    # print(f'dsize: {dsize}, scale: {scale}, vy_ratio: {vy_ratio}, vx_ratio: {vx_ratio}')
    ...
    # print(f'img_crop.shape: {img_crop.shape}')
